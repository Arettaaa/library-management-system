...
@section('content')
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <form action="{{ route('search.books') }}" method="GET" class="mb-4" id+>
                <input type="text" name="cari" placeholder="Search books..." class="px-4 py-2 border border-gray-300 rounded-md">
            ...
            <h4 class="mb-4 text-lg font-semibold flex justify-between items-center text-gray-600 dark:text-gray-300">
                ...
                <div class="flex justify-between">
                    ...
                    <button class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        <a href="{{ route('export.books') }}" class="text-white">Export Excel</a>
                    </button>
                </div>
            </h4>
