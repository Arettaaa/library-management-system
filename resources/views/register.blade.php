                    ...
                    <div class="w-full">
                        ...
                        <form action="{{route('register.post')}}" method="POST" class="form">
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Indonesia" type="text" name="address" required />
                            </label>
